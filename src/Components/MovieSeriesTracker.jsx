...
const MovieSeriesTracker = () => {
    ...
    return (
        <div>
            <div className="text-lg md:text-2xl font-semibold text-gray-600 px-12 py-4 flex items-center gap-2 uppercase shadow-lg sticky">Movies / TV Series Tracker </div>
            <div className=" pt-6">
                <select
