                        ...
                        <div className="relative p-6 flex-auto">
                            <Formik>
                                {({ values, handleChange, handleSubmit }) => (
                                    <form className="relative w-full mt-2 space-y-6">
                                        <div class="relative">
                                        ...
                                        <div class="relative flex flex-col">
                                            ...
                                            {selectedOption === "pages" && <p className="ml-4 mt-4">On Page <input type="text" className="border-b mx-2 w-24 border-gray-500 focus:ring-0 focus:outline-none text-center" placeholder="#" /> of <input type="text" className="border-b mx-2 w-24 border-gray-500 focus:ring-0 focus:outline-none text-center" placeholder="#" /></p>}
                                            {selectedOption === "percent" && <p className="ml-4 mt-4"><input type="text" className="border-b w-24 border-gray-500 focus:ring-0 focus:outline-none text-center" placeholder="#" />  % done</p>}
                                        </div>
                                    </form>
                                )}
                            </Formik>
